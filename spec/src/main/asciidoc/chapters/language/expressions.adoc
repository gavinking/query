...
The type assigned to an operator expression depends on the types of its operand expression, which, only in the case of numeric types, need not be identical.
